...
<table id="example23" class="table-bordered table-hover table-responsive" role="grid">
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu">
                          <li><a title="Verified" class="" href="<?php echo base_url('/Admin/change_shop_status');?>?id=<?php echo $vss->id; ?>&status=1&request=1">Activate</a></li>
                          <li><a title="Not Verified" class="" href="<?php echo base_url('/Admin/change_shop_status');?>?id=<?php echo $vss->id; ?>&status=0&request=2" >Deactivate</a></li>
                        </ul>
                    </div>

                        
                    <a title="Edit" class="btn btn-info btn-outline btn-circle btn-lg m-r-5" href="edit_shop/<?php echo $vss->id; ?>"><i class="ti-pencil-alt"></i></a>
        <a title="Delete" onclick="return confirm('Are you sure you want to delete this Pet Shop?')" href="deleteShop/<?php echo $vss->id; ?>" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="icon-trash"></i></a> 
