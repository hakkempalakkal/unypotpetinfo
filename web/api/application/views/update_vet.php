  <div id="page-wrapper">
       ...
       <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Edit Veterinary</h3>
                         <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <?php $attributes = array('id' => 'demo-form2', 'name'=>'randform','class'=>'form-horizontal form-label-left');
                            echo form_open_multipart('admin/update_vet', $attributes); ?>
                        <div class="col-sm-12" style="margin-right: 80px;">
                        ...
                        <br/>
                           ...
                           <div class="col-sm-5" style="margin-right: 70px;">
                        <div class="form-group">
                          <label class="col-sm-3">Latitude</label>

                          <input  type="hidden" id="name" name="id" value="<?php echo $nearby_vss->id; ?>" class="form-control">

                        <input  type="text" id="lati" name="lati" value="<?php echo $nearby_vss->lati; ?>" class="form-control" style ="height: 50px;">
                          </div>
                        </div>
                          <br/>
                           <div class="col-sm-5" style="margin-right: 70px;">
                        ...
                        <input  type="text" id="longi" name="longi" value="<?php echo $nearby_vss->longi; ?>" class="form-control" style ="height: 50px;">
                          </div>
                        </div>
                         <br/>
                           <div class="col-sm-5"  style="margin-right: 70px;">
                    ...
                    <button type="button" class="selected">Morning(AM)</button>
                     ...
                     <div class="col-sm-5" id="myDiv" style="margin-right: 80px;">
                      <div class="form-group">
                      <label class="m-t-20 ">Morning Opening Time</label>
                       <div class="input-group clockpicker">
                      <input type="text"  id="datetimepicker3" name="start_timing" class="form-control" value="<?php echo $nearby_vss->start_timing; ?>" required="required" readonly=""> 
                      <span class="input-group-addon"> <span class="glyphicon glyphicon-time"></span> 
                       ...
                       <div class="col-sm-5"  id="myDivv" style="margin-right: 80px;">
                       <div class="form-group">
                      <label class="m-t-20">Morning Closing Time</label>
                       <div class="input-group clockpicker">
                   <input type="text"  id="datetimepicker3" name="end_timing" class="form-control" value="<?php echo $nearby_vss->end_timing; ?>"  required="required" readonly=""> 
                      <span class="input-group-addon"> <span class="glyphicon glyphicon-time"></span> 
                      </div>
                      </div>
                      </div>
                    ...
                    <button type="button" class="selected1">Evening(PM)</button>
                         ...
                         <div class="col-sm-5" id="myDiv1" style="margin-right: 80px;">
                      <div class="form-group">
                      <label class="m-t-20 ">Evening Opening Time</label>
                       <div class="input-group clockpicker">
                      <input type="text"  id="datetimepicker3" name="e_open_time" class="form-control" value="<?php echo $nearby_vss->e_open_time; ?>" required="required" readonly=""> 
                      <span class="input-group-addon"> <span class="glyphicon glyphicon-time"></span> 
                      </div>
                      </div>
                      </div>
                       ...
                       <div class="col-sm-5"  id="myDiv2" style="margin-right: 80px;">
                       <div class="form-group">
                      <label class="m-t-20">Evening Closing Time</label>
                       <div class="input-group clockpicker">
                      <input type="text"  id="datetimepicker3" name="e_close_time" class="form-control" value="<?php echo $nearby_vss->e_close_time; ?>"  required="required" readonly=""> 
                      <span class="input-group-addon"> <span class="glyphicon glyphicon-time"></span> 
                      </div>
                      </div>
                      </div>
