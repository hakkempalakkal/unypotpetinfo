  <div id="page-wrapper">
       ...
       <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Edit Pet Spa</h3>
                         <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <?php $attributes = array('id' => 'demo-form2', 'name'=>'randform','class'=>'form-horizontal form-label-left');
                            echo form_open_multipart('admin/update_salon', $attributes); ?>
                        <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <input  type="hidden" id="nearby_id" name="start_timing" value="<?php echo $nearby_vss->start_timing; ?>" class="form-control">

                        <input  type="text" id="nearby_id" name="start_timing" value="<?php echo $nearby_vss->start_timing; ?>" class="form-control" style ="height: 50px;">
                          </div>
                        </div>
                        <br/> -->
