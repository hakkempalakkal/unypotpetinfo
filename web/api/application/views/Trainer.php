<div id="page-wrapper">
            ...
            <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-heading">All Trainer</br></div>
                            <div class="table-responsive">

                                             <div>

<a class="dt-button buttons-print btn btn-primary m-r-10 " tabindex="0" aria-controls="example23" href="addtrainer"
  style="float: right;"><span>Add Trainer</span></a><br/><br/>
                   ...
                   <td><?php if($vss->status==1){ ?>
                    ...
                    <td class="text-center">
                        ...
                        <ul class="dropdown-menu">
                          <li><a title="Verified" class="" href="<?php echo base_url('/Admin/change_trainer_status');?>?id=<?php echo $vss->id; ?>&status=1&request=1">Activate</a></li>
                          <li><a title="Not Verified" class="" href="<?php echo base_url('/Admin/change_trainer_status');?>?id=<?php echo $vss->id; ?>&status=0&request=2" >Deactivate</a></li>
                        </ul>
                    </div>

                        
                    <a title="Edit" class="btn btn-info btn-outline btn-circle btn-lg m-r-5" href="edit_trainer/<?php echo $vss->id; ?>"><i class="ti-pencil-alt"></i></a>

        <a title="Delete" onclick="return confirm('Are you sure you want to delete this Trainer?')" href="deleteTrainer/<?php echo $vss->id; ?>" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="icon-trash"></i></a> 
