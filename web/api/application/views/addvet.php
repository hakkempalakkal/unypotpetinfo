...
<?php if ($this->session->flashdata('msg1')) { ?>
  ...
  <?php } ?>
       <div class="row">
            <div class="col-sm-12">
              <div class="white-box">
                <h3 class="box-title m-b-0">Add Veterinary</h3>
                <br/>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_content">
                        ...
                        <input  type="hidden" name="nearby_id" value="1" required="required" class="form-control">
                          </div>
                        </div>
                    ...
                    <button type="button" class="selected1">Evening(PM)</button>
                      ...
                      <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span> 
                       ...
                       <div class="col-sm-5" style="margin-right: 50px;">
                        ...
                        <input  type="text" id="nearby_id" name="lati" value="" required="required" class="form-control">
                          </div>
                        </div>
                      ...
                      <input type="text" id="nearby_id" name="longi" value="" required="required" class="form-control">
                      </div>
                      </div>
