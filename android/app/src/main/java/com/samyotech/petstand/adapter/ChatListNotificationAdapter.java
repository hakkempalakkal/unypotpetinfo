...
public class ChatListNotificationAdapter extends RecyclerView.Adapter<ChatListNotificationAdapter.MyViewHolder> {
    private String TAG = ChatListNotificationAdapter.class.getSimpleName();
    private HashMap<String, String> params;
    private SharedPrefrence prefrence;
    private DialogInterface dialog_delete;
    private LoginDTO loginDTO;
    ChatNotificationActivity chatActivity;
    ArrayList<ChatListDTO> chatDTOlist;

    public ChatListNotificationAdapter(ChatNotificationActivity chatActivity, ArrayList<ChatListDTO> chatDTOlist) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tvTitle.setText(chatDTOlist.get(position).getSender_name());
