...
public class AdapterShowPetView extends RecyclerView.Adapter<AdapterShowPetView.ItemViewHolder> {
    ...
    @Override
    public AdapterShowPetView.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public AdapterShowPetView(Context mContext, ArrayList<GetViewDTO> getViewDTOlist) {
        this.mContext = mContext;
        this.getViewDTOlist = getViewDTOlist;
    }

    @Override
    public void onBindViewHolder(final AdapterShowPetView.ItemViewHolder holder, final int position) {

        try {


            holder.tvTitle.setText(getViewDTOlist.get(position).getUserName());
            holder.tvDate.setText(ProjectUtils.parseDateToddMMyyyy(getViewDTOlist.get(position).getCreated()));
