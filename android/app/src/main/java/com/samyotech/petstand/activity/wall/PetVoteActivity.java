...
import com.samyotech.petstand.adapter.AdapterShowPetVote;
...
public class PetVoteActivity extends AppCompatActivity implements View.OnClickListener {


    JSONObject jsonObject = new JSONObject();
    Context mContext;
    private String TAG = PetVoteActivity.class.getSimpleName();
    String postId = "";
    ArrayList<GetViewDTO> getViewDTOlist;
    AdapterShowPetVote adapterShowPetVote;
    ImageView ivBack;
    RecyclerView RVview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProjectUtils.setStatusBarGradiant(PetVoteActivity.this);
        setContentView(R.layout.activity_show_post_vote);
        mContext = PetVoteActivity.this;
    ...
    public void getView() {
        ...
        new HttpsRequest(Consts.GET_LIKED_USER, params, mContext).stringPost(TAG, new Helper() {
            @Override
            public void backResponse(boolean flag, String msg, JSONObject response) {
                ...
                if (flag) {
                    ...
                    try {
                        ...
                        adapterShowPetVote = new AdapterShowPetVote(mContext, getViewDTOlist);
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(mContext);
                        RVview.setLayoutManager(mLayoutManager);
                        RVview.setItemAnimator(new DefaultItemAnimator());
                        RVview.setAdapter(adapterShowPetVote);
