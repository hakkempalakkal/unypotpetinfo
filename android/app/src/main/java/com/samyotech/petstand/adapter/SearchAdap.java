...
public class SearchAdap extends RecyclerView.Adapter<SearchAdap.petListDTOListHolder> {
    private Context mContext;
    ArrayList<PetListDTO> list;
    private ArrayList<PetListDTO> petListDTOList = null;
    LayoutInflater inflater;

    public SearchAdap(Context mContext, ArrayList<PetListDTO> petListDTOList, LayoutInflater inflater) {
    ...
    public class petListDTOListHolder extends RecyclerView.ViewHolder {
        ...
        CustomTextView ctvAge, ctvBreed;
