...
public class ShopifyFoodDetail extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ProjectUtils.setStatusBarGradiant(ShopifyFoodDetail.this);
        setContentView(R.layout.food_detail_frag);
        mContext = ShopifyFoodDetail.this;
    ...
    public void init() {
        ...
        tvProdName.setText(foodListDTO.getTitle());
    ...
    public void addCart() {
        ...
        parmsAddCart.put(Consts.PRODUCT_ID, foodListDTO.getId());
        parmsAddCart.put(Consts.PRODUCT_NAME, foodListDTO.getTitle());
        parmsAddCart.put(Consts.PRODUCT_DESC, ProjectUtils.removeHtmlFromText(foodListDTO.getBody_html()));
        parmsAddCart.put(Consts.PRODUCT_IMG, foodListDTO.getImage().getSrc());
        parmsAddCart.put(Consts.PRICE, foodListDTO.getVariants().get(0).getPrice());
    ...
    public void addToCart() {
        ...
        new HttpsRequest(Consts.ADD_TO_CART_SHOPIFY, parmsAddCart, mContext).stringPost(TAG, new Helper() {
            @Override
