...
import com.samyotech.petstand.activity.petmarket.ShowPetMarketActivity;
...
public class CatagoryPetMarketAdapter extends RecyclerView.Adapter<CatagoryPetMarketAdapter.MyViewHolder> {
    ...
    public CatagoryPetMarketAdapter(Context context, ArrayList<PetCatList> petCatList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.cvType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(context, ShowPetMarketActivity.class);
