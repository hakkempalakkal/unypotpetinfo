...
public class AdapterNewProductsForAnim extends RecyclerView.Adapter<AdapterNewProductsForAnim.MyViewHolder> {
    ...
    public AdapterNewProductsForAnim(Context mcontext, ArrayList<FoodListDTO> productsForAnimArrayList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        if (!productsForAnimArrayList.get(i).getDiscount().equals("0")) {
            ...
            myViewHolder.binding.ctvbOld.setText("");
