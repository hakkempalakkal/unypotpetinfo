...
public class ProductWeightAdapter extends RecyclerView.Adapter<ProductWeightAdapter.MyViewHolder> {
    ...
    public ProductWeightAdapter(FoodDetail context, ArrayList<SingleFoodListDTO.ProjectDetails> petCatList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.chValue.setText(petCatList.get(position).getWeight());
