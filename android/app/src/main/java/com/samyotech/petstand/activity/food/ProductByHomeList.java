...
public class ProductByHomeList extends AppCompatActivity implements View.OnClickListener {
    ...
    private String TAG = ProductByHomeList.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProjectUtils.setStatusBarGradiant(ProductByHomeList.this);
        setContentView(R.layout.food_list_frag);
        mContext = ProductByHomeList.this;
    ...
    private void init() {
        if (getIntent().hasExtra(Consts.BRAND_NAME)) {
            brand_id = getIntent().getStringExtra(Consts.BRAND_ID);
            brand_name = getIntent().getStringExtra(Consts.BRAND_NAME);
        }
    ...
    public void getFoodList() {
        ...
        new HttpsRequest(Consts.GET_ALL_PRODUCT_BY_CAT_NAME, getparms(), mContext).stringPost(TAG, new Helper() {
            @Override
    ...
    public HashMap<String, String> getparms() {
        ...
        parms.put(Consts.CAT_NAME, brand_name);
